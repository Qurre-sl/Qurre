...
namespace Qurre.API.Controllers
{
    public class Locker
    {
        ...
        public LockerType Type
        {
            get
            {
                if (_typeCached is LockerType.Unknown)
                {
                    _typeCached = _get();
                }
                ...
                LockerType _get()
                {
                    ...
                    {
                        return LockerType.AdrenalineMedkit;
                    }

                    if (Name.Contains("RegularMedkit"))
                    {
                        return LockerType.RegularMedkit;
                    }

                    if (Name.Contains("Pedestal"))
                    {
                        return LockerType.Pedestal;
                    }

                    if (Name.Contains("MiscLocker"))
                    {
                        return LockerType.MiscLocker;
                    }

                    if (Name.Contains("RifleRack"))
                    {
                        return LockerType.RifleRack;
                    }

                    if (Name.Contains("LargeGunLocker"))
                    {
