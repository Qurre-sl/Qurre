...
{
    static Respawn() => UpdateCachedWaves();
    ...
    public static TimeBasedWave? PredictedNextWave
        => TimeLeftSortedWaves.FirstOrDefault(wave => !wave.Timer.IsPaused && wave is ILimitedWave { RespawnTokens: > 0 });
    ...
    public static void InvokeAnimation<TAnimatedWave>(TAnimatedWave spawnableWaveBase) where TAnimatedWave : SpawnableWaveBase, IAnimatedWave
    {
