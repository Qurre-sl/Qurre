    ...
    static class PickupArmor
    {
        ...
        static IEnumerable<CodeInstruction> Call(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            list.InsertRange(0, new CodeInstruction[]
            {
                ...
                new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(PickupArmor), nameof(PickupArmor.Invoke))),
        ...
        static bool Invoke(ArmorSearchCompletor instance)
        {
            try
            {
                PickupArmorEvent ev = new(instance.Hub.GetPlayer(), Pickup.SafeGet(instance.TargetPickup));
                ev.InvokeEvent();
