...
static class AddObserver
{
    ...
    static IEnumerable<CodeInstruction> Call(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        ...
        list.InsertRange(index, new CodeInstruction[]
        {
            ...
            new CodeInstruction(OpCodes.Callvirt, AccessTools.PropertyGetter(typeof(Scp173AddObserverEvent), nameof(Scp173AddObserverEvent.Allowed))),
